"""
Total Occupancy Patch Module - CAFE
...
def load_region_config(config_path: str = None, region_key: str = "cafe") -> List[Dict]:
    """
    ...
    Args:
        ...
        region_key: The key in the JSON to load (default "cafe" for this service)
