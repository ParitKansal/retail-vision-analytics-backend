"""
Total Occupancy Patch Module - KIOSK
...
def load_region_config(config_path: str = None, region_key: str = "kiosk") -> List[Dict]:
    """
    ...
    Args:
        ...
        region_key: The key in the JSON to load (default "kiosk" for this service)
